...
import { Session, SessionType, SessionSubtype, MasonicDegree, Member, LodgeOfficerRole } from '../types/masonic';
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (editingSession) {
      ...
      const newSess: Session = {
        ...
        location: formData.location || 'Templo da Loja',
    ...
    <div className="space-y-6">
      ...
      {isModalOpen && isAdmin && (
        <div className="fixed inset-0 z-50 bg-slate-950/85 backdrop-blur-sm flex flex-col items-center justify-start sm:justify-center p-2 sm:p-4 overflow-y-auto overscroll-contain">
          <div className="bg-slate-900 border border-slate-800 rounded-2xl max-w-xl w-full my-auto text-slate-200 shadow-2xl flex flex-col max-h-[92vh] overflow-hidden">
            ...
            <div className="p-4 sm:p-6 overflow-y-auto flex-1 overscroll-contain">
              ...
              <div>
                <label className="block text-slate-300 font-medium mb-1">Título da Sessão</label>
                <input
                  type="text"
                  required
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  >
                    ...
                    <option value="Magna">Magna (Pública / Iniciação / Elevação)</option>
              ...
              <div>
                <label className="block text-slate-300 font-medium mb-1 font-semibold text-amber-300">
                  Grau Exigido na Sessão (Trava de Acesso)
                </label>
                <select
                ...
                >
                  <option value="Aprendiz">Grau 1 - Aprendiz (Acesso Libre a Todos do Quadro)</option>
              ...
              <div className="pt-2 border-t border-slate-800">
                <h4 className="text-xs font-semibold text-amber-300 uppercase tracking-wider mb-2">
                  Atribuição de Cargos da Sessão
                </h4>
                ...
                <div className="grid grid-cols-2 gap-2 text-xs">
                  {['Venerável Mestre', '1º Vigilante', '2º Vigilante', 'Orador', 'Secretário', 'Chanceler'].map((role) => (
                    <div key={role}>
                      ...
                      <select
                        value={formData.officers?.[role as LodgeOfficerRole] || ''}
                        onChange={(e) =>
                          setFormData({
                            ...formData,
                            officers: {
